...
source('eprime3_dollarrward.R') # extract_EP3_DR_events
source('./vgs.R')               # extract_vgs_events
...
score_file<-function(asc_fname='example/220682rr01.asc.gz', dot_event=4, extract_events=extract_EP3_DR_events){
...
ascfile_score_stats <-function(extract_events=extract_EP3_DR_events){
    run_stats(score_file(asc_fname='example/220682rr01.asc.gz',extract_events=extract_events))
}
